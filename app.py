...
model = joblib.load('disease-prediction.pkl')

def prmo(symptom1,symptom2,symptom3,symptom4,symptom5):
...
def diseasePrediction():
    ...
    name = prmo(symptom1,symptom2,symptom3,symptom4,symptom5)
    # py -> HTML
    return render_template("disease.html", n = name)
